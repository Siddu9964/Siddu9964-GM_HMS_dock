...
<head>
    ...
    <style>
        ...
        /* Print Optimization */
        @media print {
            .reception-sidebar, .reception-navbar, .search-container, 
            .btn-action, .glass-card:has(#dailyReportForm), 
            .card-header-premium .btn-action, #alertContainer,
            .welcome-state, #welcomeState, .col-xl-5 {
                display: none !important;
            }
            .reception-main-content { margin: 0 !important; padding: 0 !important; }
            .col-xl-7 { width: 100% !important; flex: 0 0 100% !important; max-width: 100% !important; }
            .glass-card { border: none !important; box-shadow: none !important; background: white !important; }
            .timeline-block { opacity: 1 !important; transform: none !important; break-inside: avoid; }
            .timeline-content-card { border: 1px solid #ddd !important; break-inside: avoid; }
            .modern-timeline::before { background: #ddd !important; }
        }
...
<body>
                ...
                <div class="container-fluid py-4">
                        ...
                        <div class="row align-items-center">
                            ...
                            <div class="col-lg-8 col-md-9">
                                <div class="px-lg-3">
                                    ...
                                    <p class="text-muted small mb-0">Search by Patient Name, ID, or <b>Mobile Number</b> to view history</p>
                                </div>
                            </div>
                            <div class="col-lg-3 col-md-3 text-md-end mt-3 mt-md-0">
                                <select id="searchIpdNo" class="form-select select2-selection--single" style="width: 100%;">
                    ...
                    <div id="patientDashboard" style="display: none;">
                        ...
                        <div class="row mb-4">
                            ...
                            <div class="col-md-3">
                                <div class="glass-card m-0 p-3 bg-primary text-white h-100" style="background: var(--primary-gradient) !important;">
                                    <div class="h-100 d-flex flex-column justify-content-center py-1">
                                        <div class="d-flex justify-content-between align-items-center mb-1">
                                            <span class="opacity-75 small fw-medium text-uppercase letter-spacing-1" style="font-size: 0.65rem;">Patient Identity</span>
                                            <span class="fw-bold" id="displayPatientId" style="font-size: 0.95rem;">---</span>
                                        </div>
                                        <div class="d-flex justify-content-between align-items-center mb-2">
                                            <span class="opacity-75 small fw-medium text-uppercase letter-spacing-1" style="font-size: 0.65rem;">IPD Ref ID</span>
                                            <span class="fw-bold" id="displayIpdNo" style="font-size: 0.95rem;">---</span>
                                        </div>
                                        <div class="pt-2 border-top border-white border-opacity-20">
                                            <div class="d-flex align-items-center gap-2 overflow-hidden">
                                                <i class="fas fa-stethoscope opacity-75 small"></i>
                                                <span id="displayDiagnosis" class="fw-bold small text-truncate" style="font-size: 0.75rem;">---</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="col-xl-5">
                                <div class="glass-card h-100">
                                    <div class="card-header-premium">
                                        <h5><i class="fas fa-edit"></i> Documentation</h5>
                                        <button onclick="showAddReportForm()" id="addReportBtn" class="btn btn-action btn-sm btn-primary-gradient">
                                            <i class="fas fa-plus"></i> New Report
                                        </button>
                                    </div>
                                    
                                    <div class="card-body p-4">
                                        <div id="addReportForm" style="display: none;" class="fade-in-up">
                                            <form id="dailyReportForm" class="row g-4">
                                                <!-- Section 1: Logistics -->
                                                <div class="col-12">
                                                    <div class="d-flex align-items-center gap-2 mb-3">
                                                        <div class="p-2 bg-primary bg-opacity-10 rounded-circle"><i class="fas fa-clock text-primary"></i></div>
                                                        <h6 class="mb-0 fw-bold">Visit Timestamp</h6>
                                                    </div>
                                                    <div class="row g-3">
                                                        <div class="col-md-6">
                                                            <label class="form-label-sharp">Reporting Date</label>
                                                            <input type="date" id="reportDate" class="form-control input-premium" required>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="form-label-sharp">Visit Time</label>
                                                ...
                                                <div class="col-12">
                                                    <div class="d-flex align-items-center gap-2 mb-3 mt-2">
                                                        <div class="p-2 bg-success bg-opacity-10 rounded-circle"><i class="fas fa-user-md text-success"></i></div>
                                                        <h6 class="mb-0 fw-bold">Attending Physician</h6>
                                                    </div>
                                                    <div class="row g-3">
                                                        <div class="col-md-4">
                                                            <label class="form-label-sharp">Doctor ID</label>
                                                            <input type="text" id="doctorId" class="form-control input-premium" placeholder="ID" required>
                                                        </div>
                                                        <div class="col-md-8">
                                                            <label class="form-label-sharp">Full Name</label>
                                                            <input type="text" id="doctorName" class="form-control input-premium" placeholder="Dr. Full Name" required>
                                                        </div>
                                                    </div>
                                                </div>
                                                ...
                                                <div class="col-12">
                                                    <div class="d-flex align-items-center gap-2 mb-3 mt-2">
                                                        <div class="p-2 bg-info bg-opacity-10 rounded-circle"><i class="fas fa-notes-medical text-info"></i></div>
                                                        <h6 class="mb-0 fw-bold">Clinical Findings</h6>
                                                    </div>
                                                    <div class="row g-3">
                                                        <div class="col-12">
                                                            <label class="form-label-sharp">Daily Summary / Assessment</label>
                                                            <textarea id="dailySummary" class="form-control input-premium" rows="3" placeholder="Primary findings and daily assessment..." required></textarea>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="form-label-sharp">Rx Modifications</label>
                                                            <textarea id="medicalChanges" class="form-control input-premium" rows="2" placeholder="Medication changes..."></textarea>
                                                        </div>
                                                        <div class="col-md-6">
                                                            <label class="form-label-sharp">Physical Observations</label>
                                                            <textarea id="observations" class="form-control input-premium" rows="2" placeholder="Vitals, symptoms..."></textarea>
                                                        </div>
                                                    </div>
                                                </div>

                                                <!-- Section 4: Procedures & Notes -->
                                                <div class="col-12">
                                                    <div class="d-flex align-items-center justify-content-between mb-3 mt-2">
                                                        <div class="d-flex align-items-center gap-2">
                                                            <div class="p-2 bg-warning bg-opacity-10 rounded-circle"><i class="fas fa-syringe text-warning"></i></div>
                                                            <h6 class="mb-0 fw-bold">Procedures & Nursing</h6>
                                                        </div>
                                                        <button type="button" onclick="addProcedureRow()" class="btn btn-link btn-sm p-0 text-decoration-none fw-bold">
                                                            <i class="fas fa-plus"></i> Add Item
                                                        </button>
                                                    </div>
                                                    <div id="proceduresContainer" class="p-2 border rounded-xl bg-light bg-opacity-50 mb-3">
                                                        <!-- Procedure rows injected here -->
                                                        <div class="text-center py-4 no-procedures-msg">
                                                            <div class="opacity-50 mb-2">
                                                                <i class="fas fa-clipboard-list fs-4"></i>
                                                            </div>
                                                            <p class="small text-muted mb-0">No procedures logged yet.</p>
                                                            <button type="button" onclick="addProcedureRow()" class="btn btn-sm btn-outline-primary rounded-pill mt-2 px-3">
                                                                <i class="fas fa-plus me-1"></i> Add Entry
                                                            </button>
                                                        </div>
                                                    </div>
                                                    
                                                    <label class="form-label-sharp"><i class="fas fa-lock small me-1"></i> Physician Confidential Notes</label>
                                                    <textarea id="additionalNotes" class="form-control input-premium" rows="2" placeholder="Internal staff communication..."></textarea>
                                                </div>
                                                
                                                <div class="col-12 d-flex gap-2 mt-4 pt-4 border-top">
                                                    <button type="submit" class="btn btn-action btn-primary-gradient flex-grow-1 py-3">
                                                        <i class="fas fa-check-circle"></i> Commit to Electronic Record
                                                    </button>
                                                    <button type="button" onclick="hideAddReportForm()" class="btn btn-action btn-light py-3 px-4">
                                                        Cancel
                                                    </button>
                                                </div>
                                            </form>
                                        ...
                                        <div id="formPlaceholder" class="text-center py-5">
                                            <div class="mb-4">
                                                <div class="icon-circle bg-primary bg-opacity-10 p-4 d-inline-block rounded-circle" style="width: 100px; height: 100px; line-height: 52px;">
                                                    <i class="fas fa-file-signature text-primary fs-1"></i>
                                                </div>
                                            </div>
                                            <h5 class="fw-bold">Ready for Documentation</h5>
                                            <p class="text-muted small px-5">Click the "New Report" button above to start entering daily physician assessments and clinical data.</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="card-header-premium">
                                        ...
                                        <div class="d-flex align-items-center gap-2">
                                            <div class="position-relative d-none d-lg-block">
                                                <i class="fas fa-filter position-absolute top-50 start-0 translate-middle-y ms-3 text-muted small"></i>
                                                <input type="text" id="timelineFilter" class="form-control form-control-sm rounded-pill ps-5" placeholder="Filter journey..." style="width: 180px;">
                                            </div>
                                            <div class="badge rounded-pill bg-light text-dark border px-3 d-none d-md-block">
                    ...
                    <div id="welcomeState" class="text-center py-5">
                        ...
                        <p class="text-muted mx-auto" style="max-width: 500px;">
                            Access complete patient history, document daily physician visits, and monitor nursing procedures through our unified summary dashboard.
                        </p>
                        <div class="d-flex justify-content-center gap-3 mt-4">
                            <div class="badge bg-light text-dark p-2 px-3 rounded-pill border"><i class="fas fa-shield-alt text-success me-2"></i> HIPAA Compliant</div>
                            <div class="badge bg-light text-dark p-2 px-3 rounded-pill border"><i class="fas fa-sync text-primary me-2"></i> Real-time Sync</div>
                        </div>
                    </div>
    ...
    <script>
        ...
        function showAddReportForm() {
            if (isDischarged) {
                showAlert('Cannot add report. Patient has been discharged.', 'danger');
                return;
            }
